...
export default function AdminProfilPage() {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-surface p-4 sm:p-6 lg:p-8 overflow-x-hidden">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="bg-surface-container-lowest rounded-3xl p-4 sm:p-6 lg:p-8 shadow-[0_8px_30px_rgba(42,52,57,0.08)] w-full">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6 sm:mb-8">
              ...
              <div className="px-3 py-1.5 bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider rounded-full w-fit">
                Administrator
              </div>
            </div>
